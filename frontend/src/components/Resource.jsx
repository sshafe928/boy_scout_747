  ...
  return (
    <div className="w-full h-full p-6" style={{backgroundImage: 'url(https://res.cloudinary.com/dmrevelyc/image/upload/v1740607699/Animated_Shape_3_vagk64.svg)', backgroundSize: 'cover', backgroundPosition: 'center'}}>
      <div className="flex flex-col items-center border-4 border-brand-accent-warm bg-brand-accent-yellow lg:p-8">
        <header className="bg-brand-primary-gold text-white text-4xl uppercase w-full flex items-center justify-center p-4 mb-12">IMPORTANT FORMS AND RESOURCES FOR TROOP 747</header>
        <article className="flex flex-col w-full lg:flex-row">
          <section className="flex flex-col w-1/2 justify-around">
            ...
            <div onClick={() => toggleDropdown("healthcareForms")} className="w-full px-6 py-4 uppercase text-brand-primary-brown text-3xl text-center bg-brand-primary-gold cursor-pointer">
              {/* Title */}
              ...
              <section className={`overflow-hidden transition-[max-height] duration-300 ease-in-out ${openDropdown === "healthcareForms" ? "max-h-96" : "max-h-0"}`}>
                <div className="flex flex-col border-2 border-brand-accent-brown-light p-4 text-xl bg-brand-accent-warm">
                  {/* Link 1 */}
            ...
            <div onClick={() => toggleDropdown("scouterResources")} className="w-full px-6 py-4 uppercase text-brand-primary-brown text-3xl text-center bg-brand-primary-gold cursor-pointer">
              {/* Title */}
            ...
            <div onClick={() => toggleDropdown("troopResources")} className="w-full px-6 py-4 uppercase text-brand-primary-brown text-3xl text-center bg-brand-primary-gold cursor-pointer">
              {/* Title */}
            ...
            <div onClick={() => toggleDropdown("eagleResources")} className="w-full px-6 py-4 uppercase text-brand-primary-brown text-3xl text-center bg-brand-primary-gold cursor-pointer">
              {/* Title */}
